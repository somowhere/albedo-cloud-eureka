...
import com.albedo.java.modules.admin.feign.factory.RemoteLogServiceFallbackFactory;
...
public interface RemoteLogService {
	 ...
	 */
	@PostMapping("/log/")
	R<Boolean> saveLog(@RequestBody LogEntity logEntity, @RequestHeader(SecurityConstants.FROM) String from);
}
