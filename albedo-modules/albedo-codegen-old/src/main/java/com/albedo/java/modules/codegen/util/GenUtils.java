...
package com.albedo.java.modules.codegen.util;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.CharsetUtil;
import cn.hutool.core.util.StrUtil;
import com.albedo.java.modules.codegen.entity.ColumnEntity;
import com.albedo.java.modules.codegen.entity.GenConfig;
import com.albedo.java.modules.codegen.entity.TableEntity;
...
public class GenUtils {
	...
	private String getFileName(String template, String className, String packageName, String moduleName) {
		...
		if (template.contains(SERVICE_JAVA_VM)) {
			return packagePath + "common" + File.separator + className + "Service.java";
		}

		if (template.contains(SERVICE_IMPL_JAVA_VM)) {
			return packagePath + "common" + File.separator + "impl" + File.separator + className + "ServiceImpl.java";
		}
