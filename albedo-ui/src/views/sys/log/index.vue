    ...
    <basic-container>
      <el-row>
        ...
        <el-col>
          ...
          <el-table :key='tableKey' @sort-change="sortChange" :default-sort="{prop:'created_date',order:'descending'}" :data="list" v-loading="listLoading" element-loading-text="加载中..." fit highlight-current-row>
            <el-table-column
...
<!--            </el-table-column>-->
            ...
            <el-table-column align="center" label="IP地址" width="130">
              <template slot-scope="scope">
              <span>
            ...
            <el-table-column align="center" label="服务" width="130">
              <template slot-scope="scope">
              <span>
                {{scope.row.serviceId}}
              </span>
            ...
            <el-table-column align="center" label="客户端" width="300">
              <template slot-scope="scope">
              <span>
                {{scope.row.userAgent}}
              </span>
            ...
            <el-table-column align="center" label="请求地址" width="300">
              <template slot-scope="scope">
              <span>
          ...
          <span>
            ...
            <el-table-column align="center" label="创建时间" width="150" prop="created_date" sortable="custom">
              <template slot-scope="scope">
