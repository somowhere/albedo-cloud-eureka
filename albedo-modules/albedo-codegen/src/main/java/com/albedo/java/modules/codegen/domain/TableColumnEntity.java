...
@ToString
@NoArgsConstructor
public class TableColumnEntity extends IdEntity<TableColumnEntity> implements Comparable<TableColumnEntity> {
    ...
    private TableEntity tableEntity; // 归属表
    @Size(min = 1, max = 200)
    @TableField("name")
    ...
    public TableColumnEntity(String id) {
        super();
        this.id = id;
    }

    public TableColumnEntity(String name, boolean isNull, Integer sort, String comments, String jdbcType) {
        this.name = name;
        this.isNull = isNull;
        this.sort = sort;
    ...
    @Override
    public int compareTo(TableColumnEntity o) {
